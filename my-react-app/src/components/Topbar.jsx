    ...
    <div className="w-full flex justify-between items-center px-6 py-3 bg-blue-500 text-white sticky top-0 z-50 ">
      ...
      <div className="flex items-center space-x-20">
        ...
        <div className="flex items-center space-x-20">
            ...
            <img src={DocImage} alt="City Care Logo" className="w-10 h-10 rounded-full object-cover " />
      
          <div className="text-right -ml-19 mr-5">
            <p className="font-normal leading">Joselyn</p>
            <p className="text-sm font-normal ">Doctor</p>
          </div>
        </div>
      </div>
    </div>
